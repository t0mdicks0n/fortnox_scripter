...
def iterate_over_invoices(invoices, fortnox_key) :
	fortnox_invoice_id = []
...
def main(inv_spec_dir) :
	...
	# Post the invoices and get their ids
	invoice_ids = iterate_over_invoices(invoices, fortnox_key)


	pprint.pprint(invoice_ids)
	# TODO: Do a PUT request on these ID's to update the text field finance need
