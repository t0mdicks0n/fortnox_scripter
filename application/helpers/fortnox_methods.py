...
def get_all_invoices(access_token, client_secret) :
	try :
		r = requests.get(
			# TODO: Have pagination exposed to the program or loop over it or something
			url="https://api.fortnox.se/3/invoices/?page=59",
			headers = {
				"Access-Token": access_token,
				"Client-Secret": client_secret,
				"Content-Type":"application/json",
